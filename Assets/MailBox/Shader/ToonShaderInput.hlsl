...
CBUFFER_START(UnityPerMaterial)
    ...
    half _Cutoff;
    float _DirectionalLightSaturationCoef;
    half _Surface;
    half4 _HColor;
    half4 _SColor;
    half4 _FallingShadowColor;
    ...
    float _Saturation;
    half4 _FlickerColor;
    float _FlickerShineScale;
    float _FlickerShineHidingDuration;
    float _FlickerShineDelay;
    float _FlickerShineShowingDuration;
    float4 _FlickerRootPos;
    float _FlickerForwardOrBackward;
    float _StartTime;
    float _FogIntensity;
